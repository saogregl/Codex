...
// @ts-ignore
import { Theme, MultiSelect, Pagination, DatePickerInput } from "@carbon/react";
...
const index = () => {
  ...
  return (
    <div>
      ...
      <DocumentForm selectedObject={selectedObject} docTags={docTags} open={open} setOpen={setOpen} />
                ...
                <div className="scrollable-area">
                  {
                    paginatedSearchResult?.map((document) => (
                      <DocumentCard key={document.object.uuid} document={document} setSelectedObject={setSelectedObject} setOpen={setOpen} open={open} tags={docTags} />
                    ))
                  }
                </div>
              </div>
